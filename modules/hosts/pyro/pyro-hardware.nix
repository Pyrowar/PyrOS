# MAYBE: leave hardware-configuration to be auto-generated by nixos-generate-config?
# create additional module for specific changes (dualboot, secureboot, swap, btrfs, barracuda bind mounts...)
{
